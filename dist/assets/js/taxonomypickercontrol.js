...
(function (CAMControl) {
    ...
    jQuery.extend(Term.prototype, {
        ...
        toHtmlLabel: function () {
            ...
            return jQuery('<li class="cam-taxpicker-treenode-li"><div class="cam-taxpicker-treenode"><div class="cam-taxpicker-expander ' + addlClass + '"></div><img src="/_layouts/15/Images/EMMTerm.png" alt=""/><span class="cam-taxpicker-treenode-title"  data-item="' + this.Name + '|' + this.Id + '">' + this.Name + '</span></div></li>');
        }
    });
    //********************** END Term Class **********************
    ...
    function TaxonomyPicker(control, options, context, changeCallback) {
        ...
        this._initialLabels = options.initialLabels;
        ...
        this._clearTermsButton = null;// AMOLL: Button used for clearing terms
    ...
    jQuery.extend(TaxonomyPicker.prototype, {
        ...
        initialize: function () {
            ...
            if (!this._enterFillIn) {
                ...
                this._clearTermsButton = jQuery('<span class="ms-formfieldlabelcontainer" style="margin: 0;">Internet Explorer: klikk til feltet blir blått.</span><br><input type="button" title="Fjern termer" class="cam-taxpicker-clear-terms-button" value="⛌">');
            }
            if (!this._isReadOnly) {
                this._editor = jQuery('<div class="cam-taxpicker-editor" contenteditable="true"></div>');
                this._control.empty().append(this._editor).append(this._dlgButton).append(this._clearTermsButton).append(this._hiddenValidated);
            ...
            if (!this._enterFillIn) {
                ...
                this._clearTermsButton.click(Function.createDelegate(this, this.removeSelectedTerms)); //AMOLL: remove terms is clicked
            }
                    ...
                    if (suggestions.length > 0) {
                        jQuery(suggestions).each(Function.createDelegate(this, function (i, e) {
                            if (i < this._maxSuggestions) {
                                ...
                                var itemHtml = jQuery('<div class="cam-taxpicker-suggestion-item" data-item="' + e.Id + '">' + hightlightedText + '</div>');
        ...
        dialogNewTermClicked: function (event) {
            ...
            this._dlgNewNode = jQuery('<li class="cam-taxpicker-treenode-li newNode"></li>').append(jQuery('<div class="cam-taxpicker-treenode"></div>').append('<div class="cam-taxpicker-expander"></div>').append(this._dlgNewNodeEditor));
        ...
        showPickerDialog: function (event) {
            ...
            if (!this.TermSet.TermsLoaded) {
                ...
                if (this._dialog == null) {
                    ...
                    this._dlgCloseButton = jQuery('<div class="cam-taxpicker-dialog-content-close">' +
                        ...
                        '<img src="/_layouts/15/images/fgimg.png?rev=23" alt="Lukk dialogboks" style="left:-0px !important;top:-645px !important;position:absolute;" class="ms-dlgCloseBtnImg">' +
                        '</span></span> '+
                        '</div>');
                    ...
                    //build dialog body
                    var dlgSubheader = jQuery('<div class="cam-taxpicker-dialog-content-subheader"></div>');
                    ...
                    this._dlgCancelButton = jQuery('<button style="float: right;">Avbryt</button>');
                ...
                var outHtml = buildTermSetTreeLevel(termImageUrl, this.TermSet.Terms, true, "", function (html) {
                    document.getElementById('rootNode').innerHTML =
                        ...
                        '<img src="/_layouts/15/Images/EMMSpecialSet.png" alt=""/>' +
        ...
        //AMOLL: function to remove all terms in the input field and call the change callback
        removeSelectedTerms: function(event){
    ...
    function buildTermSetTreeLevel(termImageUrl, termList, show, outHtml, cb) {
        ...
        for (var i = 0, len = termList.length; i < len; i++) {
            ...
            tHtml += '<li class="cam-taxpicker-treenode-li">' +
                ...
                '</div>' +
                '<img src="/_layouts/15/Images/EMMTerm.png" alt=""/>' +
